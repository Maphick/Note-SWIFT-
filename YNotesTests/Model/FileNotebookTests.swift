...
class FileNotebookTests: XCTestCase {
    ...
    private let noteOne = Note(title: "Note One", content: "Lorem ipsum dolor sit amet...", importance: .mediumPriority)
    private let noteTwo = Note(title: "Note Two", content: "Lorem ipsum dolor sit amet...", importance: .lowPriority)
    private let noteThree = Note(title: "Note Three", content: "Lorem ipsum dolor sit amet...", importance: .mediumPriority)
